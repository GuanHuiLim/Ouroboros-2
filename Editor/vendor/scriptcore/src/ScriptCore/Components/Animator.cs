...
namespace Ouroboros
{
    public class Animator : Component
    {
        ...
        public void SetInt(string paramName, Int32 val)
        {
        ...
        public void SetInt(UInt64 id, Int32 val)
        {
        ...
        public void SetInt(UInt32 index, Int32 val)
        {
        ...
        public void SetFloat(UInt64 id, float val)
        {
        ...
        public void SetFloat(UInt32 index, float val)
        {
        ...
        public void SetBool(UInt64 id, bool val)
        {
        ...
        public void SetBool(UInt32 index, bool val)
        {
