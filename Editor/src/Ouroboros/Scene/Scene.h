...
namespace oo
{
    ...
    public:
        ...
        */
        ...
        UUID GetUUIDFromPickingId(std::int32_t pickingID) const;
        std::int32_t GeneratePickingID(UUID uuid);
        void RemovePickingID(std::int32_t pickingID);
    ...
    private:
        ...
        std::unordered_map<std::int32_t, UUID> m_pickingIdToUUID;
        std::unordered_map<UUID, std::int32_t> m_uuidToPickingId;
