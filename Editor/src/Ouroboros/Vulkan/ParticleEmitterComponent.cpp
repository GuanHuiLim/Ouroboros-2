...
namespace oo
{
    ...
    registration::class_<ParticleProperties>("Particle properties")
        ...
        .property("Colour percents", &ParticleProperties::p_colours)
        ...
        .property("Speed percents", &ParticleProperties::p_speeds)
        //(metadata(UI_metadata::SAMELINE, 1))
        .property("Speeds", &ParticleProperties::speeds)
        //(metadata(UI_metadata::SAMELINE, 0))
        .property("Rotation percents", &ParticleProperties::p_rotations)
        //(metadata(UI_metadata::SAMELINE, 1))
        .property("Rotations", &ParticleProperties::rotations)
        //(metadata(UI_metadata::SAMELINE, 0))
        .property("Direction percents", &ParticleProperties::p_directions)
        //(metadata(UI_metadata::SAMELINE, 1))
        .property("Directions", &ParticleProperties::directions)
        //(metadata(UI_metadata::SAMELINE, 0))
        .property("Size percents", &ParticleProperties::p_sizes)
        //(metadata(UI_metadata::SAMELINE, 1))
