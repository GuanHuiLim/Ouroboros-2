...
namespace oo
{
    RTTR_REGISTRATION
    {
        ...
        registration::class_<oo::JustCreatedComponent>("This Object is just created")
            .property_readonly("Entity ID", &JustCreatedComponent::entityID)
            .property_readonly("UUID", &JustCreatedComponent::uuid)
            ;
    }
