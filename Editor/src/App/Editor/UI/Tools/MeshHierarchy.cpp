...
void MeshHierarchy::Show()
{
	...
	/*if (ImGui::Button("Generate Animation"))
	{
		...
		if constexpr(true)
		{
			...
			fn(1, 397, "Char_Idle");
			fn(399, 436, "Char_Jump");
			fn(437, 468, "Char_Land");
			fn(481, 550, "Char_Falling");
			fn(552, 600, "Char_Running");
			fn(602, 700, "Char_Punch1");
			fn(702, 780, "Char_Punch2");
			fn(782, 867, "Char_Punch3");
			fn(869, 1045, "Char_KeyHit1");
			fn(1047, 1210, "Char_KeyHit2");
			fn(1330, 1526, "Char_KeyHit3");
			fn(1528, 1582, "Char_KeyAim");
			fn(1583, 1660, "Char_KeyIdle");
			fn(1662, 1700, "Char_KeyThrow");
			fn(1702, 1750, "Char_KeyAim_WalkForward");
			fn(1752, 1800, "Char_KeyAim_StrafeLeft");
			fn(1802, 1850, "Char_KeyAim_StrafeRight");
			fn(1852, 1900, "Char_KeyAim_WalkBack");
			fn(1924, 1961, "Char_KeyCalling");
			fn(1963, 2069, "Char_KeyRetrieval");
			fn(2071, 2104, "Char_KeyAim_Jump");
			fn(2105, 2120, "Char_KeyAim_Land");
			fn(2122, 2150, "Char_KeyAim_Falling");
			fn(2152, 2200, "Char_Falling_KeyThrow");
			fn(2210, 2262, "Char_Falling_KeyCalling");
			fn(2262, 2320, "Char_Falling_KeyRetrieval");
			fn(2322, 2360, "Char_Dash");
			fn(2362, 2396, "Char_Sprint");
			fn(2398, 2420, "Char_Stagger1");
			fn(2422, 2444, "Char_Stagger2");
			fn(2446, 2468, "Char_Stagger3");
			fn(2470, 2600, "Char_Death");
			fn(2602, 2710, "Char_HighKeyHit");
			fn(2712, 2900, "Char_RespawnFromRespawner");
			fn(2902, 2932, "Char_KnockedDown_KeyPopsOut");
			fn(2933, 2975, "Char_KnockedDown_Land");
			fn(2976, 3078, "Char_KnockedDown_Recovery");
			fn(3080, 3140, "Char_KnockedDown_Falling");
			fn(3142, 3180, "Char_DoubleJump");
